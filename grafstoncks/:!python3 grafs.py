...
def generar_grafica_ipsa():
    ...
    # 4. Graficar
    fig, ax = plt.subplots(figsize=(10, 4)) # Formato ancho
    ...
    ax.text(0.02, -0.1, f"IPSA", transform=ax.transAxes, color="white", 
    ...
    # 6. Guardar
    nombre_archivo = "ipsa.png"
    plt.savefig(nombre_archivo, transparent=True, dpi=100, bbox_inches='tight', pad_inches=0)
    plt.close()
    
    print(f"Gráfica generada exitosamente: {nombre_archivo}")

if __name__ == "__main__":
    generar_grafica_ipsa()
